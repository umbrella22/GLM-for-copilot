...
const zh: Translations = {
	...
	'auth.promptForChannel': '请输入 {0} 的 API Key 或 Coding Plan Token。',
	'auth.placeholder': 'GLM API Key 或 Coding Plan Token',
	'auth.emptyValidation': 'API Key 不能为空',
	'auth.saved': 'API Key 已安全保存。',
	'auth.savedForChannel': '{0} 的 API Key 已安全保存。',
	'auth.removed': 'API Key 已移除。',
	'auth.removedForChannel': '{0} 的 API Key 已移除。',
	'auth.selectChannel.set': '选择要设置 API Key 的连接通道',
	'auth.selectChannel.get': '选择要获取 API Key 的连接通道',
	'auth.selectChannel.clear': '选择要清除 API Key 的连接通道',
	'auth.channel.china-coding': '国内 · Coding Plan',
	'auth.channel.china-standard': '国内 · 标准 API',
	'auth.channel.international-coding': '国际 · Coding Plan',
	...
	// Model manager
	'manager.title': 'GLM 模型与连接',
	'manager.view.models': '模型',
	'manager.view.connections': '连接',
	'manager.view.vision': '视觉代理',
	'manager.scope': '配置范围',
	'manager.action.refresh': '刷新',
	...
	'manager.column.imageMode': '图片',
	'manager.column.status': '状态',
	'manager.action.addModel': '添加自定义模型',
	'manager.models.empty': '当前配置范围内没有可用模型。',
	'manager.inspector.title': '模型详情',
	'manager.field.modelName': '显示名称',
	'manager.field.modelId': 'Copilot 模型 ID',
	'manager.field.endpointRoute': '连接线路',
	'manager.field.visionMode': '图片处理方式',
	'manager.visionMode.proxy': '视觉代理',
	'manager.visionMode.proxyHint':
	...
	'manager.field.thinking': '支持思考模式',
	'manager.field.valueSource': '当前值来源',
	'manager.action.saveChanges': '保存更改',
	'manager.action.resetOverride': '恢复继承值',
	'manager.action.deleteModel': '删除模型',
	'manager.action.close': '关闭',
	'manager.customModel.title': '添加自定义模型',
	'manager.customModel.idHint': '这是 Copilot 模型选择器使用的稳定 ID，创建后不可更改。',
	'manager.connections.heading': '连接',
	'manager.connections.description':
		'设置默认官方线路、自定义兼容 URL，并集中管理各计费通道的凭据。',
	'manager.field.defaultEndpoint': '默认 Endpoint',
	'manager.field.customBaseUrl': '自定义兼容 Base URL',
	'manager.field.customBaseUrlHint':
		'仅影响使用“跟随默认”线路的模型；指定官方线路的模型不会使用此 URL。',
	'manager.field.resolvedUrl': '最终 URL',
	'manager.field.protocol': '协议',
	'manager.field.credentialChannel': '凭据通道',
	'manager.key.configured': 'Key 已配置',
	'manager.key.missing': 'Key 未配置',
	'manager.action.saveConnection': '保存连接',
	'manager.credentials.heading': 'API Key',
	'manager.credentials.description':
		'Coding Plan 与标准 API 的凭据彼此独立；同地区的 OpenAI 和 Anthropic Endpoint 共享 Coding Plan Key。',
	'manager.credentials.modelsUsing': '使用模型',
	'manager.action.setKey': '设置 Key',
	'manager.action.replaceKey': '替换 Key',
	'manager.action.clearKey': '清除',
	'manager.action.getKey': '获取 Key',
	'manager.vision.heading': '视觉代理',
	'manager.vision.description':
		'配置代理图片识别来源。模型是否直接接收图片，请在“模型”视图中设置。',
	'manager.vision.headersConfigured':
		'已配置以下 Header：{0}。输入完整 JSON 可替换；留空则保持不变。',
	'manager.noSelection': '请选择一个模型。',
	'manager.error.invalidNumber': '请输入大于 0 的整数。',
	'manager.error.invalidJson': '{0} 必须是 JSON 对象。',
	'manager.error.required': '请填写所有必填字段。',
	'manager.error.nonCanonicalModelId': '模型 ID 和 API 模型 ID 的首尾不能包含空白字符。',
	'manager.working': '正在处理...',
	'manager.scope.global': '用户',
	'manager.scope.workspace': '工作区',
	'manager.scope.workspaceFolder': '当前工作区文件夹',
	'manager.scope.builtIn': '内置默认值',
	'manager.route.default': '跟随默认连接',
	'manager.route.sameRegionStandard': '默认地区 · 标准 API',
	'manager.endpoint.china-coding': '国内 · Coding Plan',
	'manager.endpoint.china-standard': '国内 · 标准 API',
	'manager.endpoint.china-anthropic': '国内 · Anthropic',
	'manager.endpoint.international-coding': '国际 · Coding Plan',
	'manager.endpoint.international-standard': '国际 · 标准 API',
	'manager.endpoint.international-anthropic': '国际 · Anthropic',
	'manager.status.ready': '可用',
	'manager.status.invalid': '配置无效',
	'manager.status.saved': '更改已保存',
	'manager.credential.china-coding.description': '国内 Coding Plan Key',
	'manager.credential.china-standard.description': '国内按量付费标准 API Key',
	'manager.credential.international-coding.description': '国际 Coding Plan Key',
	'manager.credential.international-standard.description': '国际按量付费标准 API Key',
	'manager.credential.codingProtocols': 'OpenAI / Anthropic 共享凭据',
	'manager.credential.standardProtocol': 'OpenAI Chat Completions',
	'manager.action.confirmDelete': '删除',
	'manager.action.confirmClear': '清除',
	'manager.confirm.deleteModel': '确定删除自定义模型“{0}”吗？',
	'manager.confirm.clearKey': '确定清除“{0}”的 Key 吗？',
	'manager.vision.vscodeDetail': '使用所选 VS Code 视觉语言模型。',
	'manager.error.modelNotFound': '未找到模型“{0}”。',
	'manager.error.modelExists': '模型 ID“{0}”已存在。',
	'manager.error.builtInDelete': '内置模型不能删除，只能恢复其覆盖配置。',
	'manager.error.invalidBaseUrl': '请输入有效的 HTTP 或 HTTPS Base URL。',
	'manager.error.contextWindowTooSmall': '上下文窗口必须大于最大输出 token 数。',
	'manager.error.invalidCredential': '凭据通道无效。',
	'manager.error.invalidEndpoint': '连接线路无效。',
	'manager.error.invalidEndpointType': '请选择视觉代理 Endpoint 类型。',
	'manager.error.invalidJsonObject': '请输入合法的 JSON 对象。',
	'manager.error.invalidVisionMode': '图片处理方式无效。',
	'manager.error.requiredField': '{0} 不能为空。',
	'manager.error.staleRevision': '配置已在其他位置更新，请刷新后重试。',
	'manager.error.unsupportedRoute': '{0} 不支持所选连接线路。',
	...
	'usage.queryPartiallyFailed': '部分连接通道用量刷新失败（{0} 个），其余结果已更新。',
	'usage.status.name': 'GLM 用量',
	'usage.status.title': 'GLM Coding Plan',
	'usage.status.waiting': '正在等待套餐用量刷新。',
	'usage.status.session': '会话',
	'usage.status.weekly': '每周',
	'usage.status.mcpMonthlyQuota': 'MCP 每月额度',
	'usage.status.window.fiveHours': '5 小时滚动',
	'usage.status.window.sevenDays': '7 天滚动',
	'usage.status.window.monthly': '每月',
	'usage.tooltip.refresh': '刷新',
	'usage.tooltip.settings': '设置',
	'usage.tooltip.plan': '套餐',
	'usage.tooltip.renews': '续期时间',
	'usage.tooltip.resetsIn': '{0} 后重置',
	'usage.tooltip.resetNow': '即将重置',
	'usage.tooltip.duration.days': '{0} 天',
	'usage.tooltip.duration.hours': '{0} 小时',
	'usage.tooltip.duration.minutes': '{0} 分钟',
	...
	// [FORK]
	'command.resetCodingPlanPreset.partial':
		'已部分恢复 GLM Coding Plan 预设（{0}/{1} 项）。失败项：\n{2}',
	// [FORK]
	'command.resetCodingPlanPreset.failed':
	...
	// [FORK]
	'command.applyCodingPlanPreset.partial':
		'已为 GLM Coding Plan 套餐部分应用推荐配置（{0}/{1} 项写入）。失败项：\n{2}',
	// [FORK]
	'command.applyCodingPlanPreset.failed':
	...
	'vision.mcp.fallbackToProxy':
		'当前会话未检测到可用的图片 MCP 工具，已自动回退到视觉代理模式处理本请求的图片。如需使用 MCP 图片模式，请在设置中启用一个能读取本地图片的工具（如官方 zai-mcp-server），或通过 “glm-copilot.mcp.imageCapableTools” 添加聊天工具列表中的完整运行时 ID。\n\n',
	// [FORK] PR #15 F2
	'vision.mcp.conflict.noImageTool':
		'当前模型的图片处理方式为 “MCP 工具”，但本会话没有可用的图片 MCP 工具，且未配置视觉代理。MCP 图片模式需要一个能读取本地图片的工具。请：（1）启用一个支持本地图片路径的 MCP 工具（如官方 zai-mcp-server）；或（2）通过 “glm-copilot.mcp.imageCapableTools” 添加聊天工具列表中的完整运行时 ID；或（3）配置视觉代理（在 “GLM: 管理模型与连接” 中设置视觉代理模型）。',
};
...
const en: Translations = {
	...
	'auth.promptForChannel': 'Enter the API key or Coding Plan token for {0}.',
	...
	'auth.savedForChannel': 'API key for {0} saved.',
	'auth.removed': 'GLM API key removed.',
	'auth.removedForChannel': 'API key for {0} removed.',
	'auth.selectChannel.set': 'Select a connection channel to set its API key',
	'auth.selectChannel.get': 'Select a connection channel to get an API key',
	'auth.selectChannel.clear': 'Select a connection channel to clear its API key',
	'auth.channel.china-coding': 'China · Coding Plan',
	'auth.channel.china-standard': 'China · Standard API',
	'auth.channel.international-coding': 'International · Coding Plan',
	...
	'auth.notConfiguredForChannel':
		'No API key is configured for connection channel {0}. Run "GLM: Set API Key".',
	...
	// Model manager
	'manager.title': 'GLM Models & Connections',
	'manager.view.models': 'Models',
	'manager.view.connections': 'Connections',
	'manager.view.vision': 'Vision Proxy',
	'manager.scope': 'Scope',
	'manager.action.refresh': 'Refresh',
	...
	'manager.column.imageMode': 'Images',
	'manager.column.status': 'Status',
	'manager.action.addModel': 'Add custom model',
	'manager.models.empty': 'No models are available in this configuration scope.',
	'manager.inspector.title': 'Model details',
	'manager.field.modelName': 'Display name',
	'manager.field.modelId': 'Copilot model ID',
	'manager.field.endpointRoute': 'Connection route',
	'manager.field.visionMode': 'Image handling',
	'manager.visionMode.proxy': 'Vision proxy',
	'manager.visionMode.proxyHint':
		'Images are converted to text by the Vision Proxy. This model receives the description, not the image data.',
	...
	'manager.field.thinking': 'Supports thinking mode',
	'manager.field.valueSource': 'Value source',
	'manager.action.saveChanges': 'Save changes',
	'manager.action.resetOverride': 'Reset to inherited',
	'manager.action.deleteModel': 'Delete model',
	'manager.action.close': 'Close',
	'manager.customModel.title': 'Add custom model',
	'manager.customModel.idHint':
		'This is the stable ID shown to the Copilot model picker and cannot be changed later.',
	'manager.connections.heading': 'Connections',
	'manager.connections.description':
		'Choose the default official route, configure a compatible URL, and manage credentials by billing channel.',
	'manager.field.defaultEndpoint': 'Default endpoint',
	'manager.field.customBaseUrl': 'Custom compatible base URL',
	'manager.field.customBaseUrlHint':
		'Only models using the default route inherit this URL. Explicit official routes never use it.',
	'manager.field.resolvedUrl': 'Resolved URL',
	'manager.field.protocol': 'Protocol',
	'manager.field.credentialChannel': 'Credential channel',
	'manager.key.configured': 'Key configured',
	'manager.key.missing': 'Key missing',
	'manager.action.saveConnection': 'Save connection',
	'manager.credentials.heading': 'API keys',
	'manager.credentials.description':
		'Coding Plan and Standard API credentials are independent. OpenAI and Anthropic endpoints in the same region share the Coding Plan key.',
	'manager.credentials.modelsUsing': 'Models using',
	'manager.action.setKey': 'Set key',
	'manager.action.replaceKey': 'Replace key',
	'manager.action.clearKey': 'Clear',
	'manager.action.getKey': 'Get key',
	'manager.vision.heading': 'Vision Proxy',
	'manager.vision.description':
		'Configure the proxy image-recognition source. Choose whether a model receives images directly from the Models view.',
	'manager.vision.headersConfigured':
		'Configured header names: {0}. Enter complete JSON to replace them, or leave blank to keep them.',
	'manager.noSelection': 'Select a model to continue.',
	'manager.error.invalidNumber': 'Enter a positive integer.',
	'manager.error.invalidJson': '{0} must be a JSON object.',
	'manager.error.required': 'Complete all required fields.',
	'manager.error.nonCanonicalModelId':
		'Model IDs and API model IDs cannot begin or end with whitespace.',
	'manager.working': 'Working...',
	'manager.scope.global': 'User',
	'manager.scope.workspace': 'Workspace',
	'manager.scope.workspaceFolder': 'Current workspace folder',
	'manager.scope.builtIn': 'Built-in default',
	'manager.route.default': 'Follow default connection',
	'manager.route.sameRegionStandard': 'Default region · Standard API',
	'manager.endpoint.china-coding': 'China · Coding Plan',
	'manager.endpoint.china-standard': 'China · Standard API',
	'manager.endpoint.china-anthropic': 'China · Anthropic',
	'manager.endpoint.international-coding': 'International · Coding Plan',
	'manager.endpoint.international-standard': 'International · Standard API',
	'manager.endpoint.international-anthropic': 'International · Anthropic',
	'manager.status.ready': 'Ready',
	'manager.status.invalid': 'Invalid configuration',
	'manager.status.saved': 'Changes saved',
	'manager.credential.china-coding.description': 'China Coding Plan key',
	'manager.credential.china-standard.description': 'China pay-as-you-go Standard API key',
	'manager.credential.international-coding.description': 'International Coding Plan key',
	'manager.credential.international-standard.description':
		'International pay-as-you-go Standard API key',
	'manager.credential.codingProtocols': 'Shared by OpenAI and Anthropic',
	'manager.credential.standardProtocol': 'OpenAI Chat Completions',
	'manager.action.confirmDelete': 'Delete',
	'manager.action.confirmClear': 'Clear',
	'manager.confirm.deleteModel': 'Delete custom model "{0}"?',
	'manager.confirm.clearKey': 'Clear the key for "{0}"?',
	'manager.vision.vscodeDetail': 'Uses the selected VS Code vision language model.',
	'manager.error.modelNotFound': 'Model "{0}" was not found.',
	'manager.error.modelExists': 'Model ID "{0}" already exists.',
	'manager.error.builtInDelete':
		'Built-in models cannot be deleted; reset their overrides instead.',
	'manager.error.invalidBaseUrl': 'Enter a valid HTTP or HTTPS base URL.',
	'manager.error.contextWindowTooSmall':
		'The context window must be greater than the maximum output token count.',
	'manager.error.invalidCredential': 'Invalid credential channel.',
	'manager.error.invalidEndpoint': 'Invalid connection route.',
	'manager.error.invalidEndpointType': 'Select a Vision Proxy endpoint type.',
	'manager.error.invalidJsonObject': 'Enter a valid JSON object.',
	'manager.error.invalidVisionMode': 'Invalid image handling mode.',
	'manager.error.requiredField': '{0} is required.',
	'manager.error.staleRevision': 'Configuration changed elsewhere. Refresh and try again.',
	'manager.error.unsupportedRoute': '{0} does not support the selected connection route.',
	...
	'usage.queryPartiallyFailed':
		'Usage refresh failed for {0} connection channel(s); other results were updated.',
	'usage.status.name': 'GLM usage',
	'usage.status.title': 'GLM Coding Plan',
	'usage.status.waiting': 'Waiting for Coding Plan usage to refresh.',
	'usage.status.session': 'Session',
	'usage.status.weekly': 'Weekly',
	'usage.status.mcpMonthlyQuota': 'Monthly MCP quota',
	'usage.status.window.fiveHours': '5h rolling',
	'usage.status.window.sevenDays': '7-day rolling',
	'usage.status.window.monthly': 'Monthly',
	'usage.tooltip.refresh': 'Refresh',
	'usage.tooltip.settings': 'Settings',
	'usage.tooltip.plan': 'Plan',
	'usage.tooltip.renews': 'Renews',
	'usage.tooltip.resetsIn': 'Resets in {0}',
	'usage.tooltip.resetNow': 'Resetting now',
	'usage.tooltip.duration.days': '{0}d',
	'usage.tooltip.duration.hours': '{0}h',
	'usage.tooltip.duration.minutes': '{0}m',
	...
	// [FORK] PR #15 F2
	'vision.mcp.fallbackToProxy':
		'No image-capable MCP tool is available in this session; this request\'s images are being handled by the vision proxy instead. To use MCP image mode, enable a tool whose schema accepts a local image path (for example the official zai-mcp-server), or add the exact runtime tool ID via "glm-copilot.mcp.imageCapableTools".\n\n',
	// [FORK] PR #15 F2
	'vision.mcp.conflict.noImageTool':
		'This model\'s vision mode is "MCP tool", but no image-capable MCP tool is available in this session and no vision proxy is configured. MCP image mode needs a tool whose schema can read the stored local image path. Either (1) enable an image-capable MCP tool (for example the official zai-mcp-server); (2) add the exact runtime tool ID via "glm-copilot.mcp.imageCapableTools"; or (3) configure a vision proxy (set a vision proxy model under "GLM: Manage Models and Connections").',
};
