...
- GLM API Key，从 [www.bigmodel.cn/usercenter/proj-mgmt/apikeys](https://www.bigmodel.cn/usercenter/proj-mgmt/apikeys) 获取；使用自定义 `glm-copilot.baseUrl` 时也可使用兼容的 provider token
...
| 设置项                                       | 默认值                                        | 说明                                                                                                                                                                                                                                                                                                                                                  |
| -------------------------------------------- | --------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `glm-copilot.baseUrl`                        | `https://open.bigmodel.cn/api/coding/paas/v4` | API 端点。国内通用 API：`https://open.bigmodel.cn/api/paas/v4`；国际版 Coding Plan：`https://api.z.ai/api/coding/paas/v4`；国际版通用 API：`https://api.z.ai/api/paas/v4`                                                                                                                                                                             |
| `glm-copilot.maxTokens`                      | `0`                                           | 最大输出 Token 数（`0` = 不限制）。可用于成本控制                                                                                                                                                                                                                                                                                                     |
| `glm-copilot.modelIdOverrides`               | 预填官方 ID 映射                              | GLM-5.2、GLM-4.6V-Flash 和 GLM-5-Turbo 对应的 API 模型 ID。GLM-4.6V-Flash 的覆盖项也会用于自动视觉代理模式。仅在使用模型名不同的兼容第三方 API 时修改                                                                                                                                                                                                 |
...
本项目参考了 [Vizards/deepseek-v4-for-copilot](https://github.com/Vizards/deepseek-v4-for-copilot) 的思路与大部分实现模式。感谢原作者；如涉及再分发或派生使用，应按原项目 MIT License 要求保留相应版权与许可声明。
