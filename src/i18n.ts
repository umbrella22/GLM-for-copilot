...
const zh: Translations = {
  ...
  "auth.notConfigured":
    'API Key 未配置，请在命令面板运行 "GLM: 设置 API Key"。',
  ...
  "vision.panel.hint.extraBody":
    "会合并进请求体，不能覆盖 model、messages、input 或 stream。",
  "vision.panel.placeholder.openaiEndpoint":
    "https://api.example.com/v1/chat/completions",
  "vision.panel.placeholder.openaiResponsesEndpoint":
    "https://api.example.com/v1/responses",
  "vision.panel.placeholder.anthropicEndpoint":
    "https://api.example.com/v1/messages",
  "vision.panel.placeholder.endpointType": "选择端点类型",
  "vision.panel.placeholder.enterApiKey": "输入 API Key",
  "vision.panel.endpointType.openaiChatCompletions":
  ...
  "vision.panel.status.endpointSavedWithKey":
    "API 端点和 API Key 已保存，并已启用 API 端点。",
  ...
  "vision.proxy.error.customHeaderValueString":
    '自定义 header "{0}" 的值必须是字符串。',
  "vision.proxy.error.customHeaderValueInvalid":
    '自定义 header "{0}" 的值无效。',
  "vision.proxy.error.invalidUrl": "视觉代理端点 URL 无效。",
  "vision.proxy.error.invalidUrlProtocol":
    "视觉代理端点 URL 必须使用 http:// 或 https://。",
  ...
  "vision.proxy.error.unsupportedAnthropicResponse":
    "Anthropic-compatible 视觉响应格式不受支持。",
  "vision.proxy.error.unsupportedOpenAIResponse":
    "OpenAI-compatible 视觉响应格式不受支持。",
  "vision.proxy.error.unsupportedOpenAIContent":
    "OpenAI-compatible 视觉响应内容格式不受支持。",
  ...
  "error.http.402":
    "[{0}] 账号余额不足。请确认账户余额，并前往充值页面进行充值。",
  "error.http.422": "[{0}] 请求体参数错误。请根据错误信息提示修改相关参数。",
  "error.http.429":
    "[{0}] 请求速率（TPM 或 RPM）达到上限。请合理规划您的请求速率。",
...
const en: Translations = {
  ...
  "auth.prompt":
    "Enter your GLM API key, Coding Plan token, or compatible provider token.",
  ...
  "vision.panel.endpointType.anthropicMessages":
  ...
  "vision.panel.hint.endpointTypeSelected":
    "Using selected endpoint type: {0}.",
  "vision.panel.hint.apiKeySet":
    "Stored API key is set. Enter a new key to replace it.",
  "vision.panel.hint.apiKeyUnset":
    "API key will be stored in VS Code SecretStorage.",
  "vision.panel.cost.tokenCost": "Cost: {0} credits / 1M tokens",
  "vision.panel.cost.longContextTokenCost":
    "Long context: {0} credits / 1M tokens",
  ...
  "vision.panel.status.autoSelected":
    "Automatic mode is active: GLM-4.6V-Flash is tried first.",
  ...
  "vision.panel.status.testSucceeded":
    "Vision proxy responded. Review the sample below.",
  ...
  "vision.panel.status.endpointSaved":
    "API endpoint saved. API endpoint is now active.",
  "vision.panel.status.apiKeyCleared": "Saved API key cleared.",
  "vision.panel.summary.noVSCodeVision.title":
    "Current: no VS Code vision model",
  "vision.panel.summary.noVSCodeVision.detail":
  ...
  "vision.panel.summary.apiNotConfigured.title":
    "Current: API endpoint not configured",
  "vision.panel.summary.apiNotConfigured.detail":
  ...
  "vision.proxy.error.configurationInvalid":
    "Vision proxy configuration is invalid.",
  "vision.proxy.error.providerFamilyInvalid":
    "Vision proxy provider type is invalid.",
  "vision.proxy.error.apiTypeInvalid": "Vision proxy API type is invalid.",
  "vision.proxy.error.fieldRequired": "{0} is required.",
  "vision.proxy.error.extraBodyObject":
    "Additional request body JSON must be an object.",
  "vision.proxy.error.extraBodyProtectedKey":
    'Additional request body cannot override "{0}".',
  "vision.proxy.error.customHeadersObject": "Custom headers must be an object.",
  "vision.proxy.error.customHeaderNameEmpty":
    "Custom header name cannot be empty.",
  "vision.proxy.error.customHeaderNameInvalid":
    'Custom header "{0}" is invalid.',
  "vision.proxy.error.customHeaderValueString":
    'Custom header "{0}" must have a string value.',
  "vision.proxy.error.customHeaderValueInvalid":
    'Custom header "{0}" has an invalid value.',
  ...
  "vision.proxy.error.notFound":
    "Vision proxy endpoint or model not found at {0}.",
  "vision.proxy.error.payloadTooLarge":
    "Vision proxy image payload too large ({0}).",
  "vision.proxy.error.rateLimited": "Vision proxy rate limited ({0}).",
  "vision.proxy.error.providerUnavailable":
    "Vision proxy provider unavailable ({0}).",
  ...
  "vision.proxy.error.network.interrupted":
    "Vision proxy connection was interrupted ({0}).",
  "vision.proxy.error.network.timeout":
    "Vision proxy network connection timed out ({0}).",
  "vision.proxy.error.network.tls":
    "Vision proxy TLS/certificate verification failed ({0}).",
  "vision.proxy.error.network.aborted":
    "Vision proxy request was aborted ({0}).",
  "vision.proxy.error.network.protocol":
  ...
  "vision.proxy.error.network.generic":
    "Vision proxy network request failed ({0}).",
  "vision.proxy.error.emptyResponse":
    "Vision proxy returned an empty response.",
  "vision.proxy.error.unsupportedAnthropicResponse":
  ...
  // Usage
  "usage.notConfigured":
    "Configure an API key before querying GLM Coding Plan usage.",
  "usage.unsupportedBaseUrl":
  ...
  "usage.querySucceeded":
    "GLM Coding Plan usage has been written to the output panel.",
  ...
  "extension.activateFailed":
    'GLM failed to activate. Run "GLM: Show Logs" for details.',
